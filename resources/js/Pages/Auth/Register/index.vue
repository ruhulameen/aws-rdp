<template>
  <AuthLayout>
    ...
    <Form action="/register" method="post" #default="{ errors, processing, wasSuccessful }">
      <div class="mb-4">
      ...
      <div v-if="wasSuccessful" class="mt-4 text-green-600 font-bold">Registration successful!</div>
    </Form>
  </AuthLayout>
</template>
<script setup>
